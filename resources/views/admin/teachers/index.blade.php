                          ...
                          <div class="card-body  bg-transparent border-bottom d-flex justify-content-between">
                              ...
                              <div class="dropdown text-end" style="margin-bottom: 70px">
                                  ...
                                  <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare2">
                                      ...
                                      <li><a class="dropdown-item" href="{{route('teacher.courses',$teacher->id)}}"><i class="bi bi-laptop fa-fw me-2"></i>حصص المعلم</a></li>
                                  </ul>
                              </div>
                          </div><br>
                      </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('teachers.store')}}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="hour_price" class="form-label">سعر الساعة </label>
                            <input type="text" class="form-control" id="hour_price" name="hour_price" required>
                        </div>
                        <div class="mb-3">
