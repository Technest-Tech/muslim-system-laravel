...
class CalendarController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $events = $timetableQuery->get();
        
        \Log::info('Export query result count:', ['count' => $events->count()]);
        ...
        $html = view('admin.calendar.pdf-report', compact('events', 'start', 'end', 'studentName', 'teacherName'))->render();
